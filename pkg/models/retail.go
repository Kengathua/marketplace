...
type SuperCategory struct {
	common.Base       `gorm:"embedded"`
	DivisionID        uuid.UUID `gorm:"foreignKey:ID" json:"division_id"`
...
type Category struct {
	common.Base     `gorm:"embedded"`
	SuperCategoryID uuid.UUID     `gorm:"foreignKey:ID" json:"super_category_id"`
...
type ItemType struct {
	...
	CategoryID       uuid.UUID `gorm:"foreignKey:ID" json:"category_id"`
...
type Brand struct {
	...
	// ItemTypes []*ItemType `gorm:"many2many:brand_item_type;" json:"item_types"`
}
...
type ItemAttribute struct {
	common.BaseModel `gorm:"embedded"`
	ItemID           uuid.UUID `gorm:"foreignKey:ID" json:"item_id"`
